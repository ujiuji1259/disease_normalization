...
class MyReader(object):
    ...
    """
    def __init__(self, dataset_folder, s1_col_idx=0, s2_col_idx=1, has_header=False, delimiter="\t",
    ...
    def get_examples(self, filename, max_examples=0):
        ...
        for id, row in enumerate(data):
            ...
            examples.append(InputExample(guid=filename+str(id), texts=[s1, s2], label=1))
